...
export const EditPost = ({index}) => {
    return (
        <div id="edit-post-form" className="container edit-post visible overlay" >
            ...
            <h3>
                <input name="title"  required placeholder="Title" className="form-control" type="text" id="edit-title" autoFocus="" /> </h3> <br/>
                <p>
                    <textarea name="body"  required placeholder="Type your body here." className="form-control" id="edit-body" rows="3"></textarea></p>
