...
var blogPreview = document.querySelector("#preview");
var newBlogPostform = document.querySelector('#blog-form');
var postsContainer = document.querySelector('#posts>.container');
var editForm = document.querySelector('#edit-post-form');
var edit_close_btn = document.querySelector('#edit-close-btn');
var ourPost = {
  "title": "",
  "body": "",
  "post_time": ""
};
blogTitle.addEventListener('keyup', function (e) {
  var text = e.target.value;
  blogPreview.querySelector('h3.title').innerText = text;
  ourPost.title = text;
});
blogBody.addEventListener('keyup', function (e) {
  var text = e.target.value;
...
window.addEventListener('load', function (event) {
  var dbPosts = JSON.parse(localStorage.getItem('post'));
  ...
  if (dbPosts) {
    dbPosts.forEach(function (post, index) {
      ...
      postElement.innerHTML = "\n          <h3>".concat(post.title, "</h3>\n          <p>").concat(post.body, "</p>\n          <div class=\"row settings-row\" >\n          <div>\n            <i class=\"fa fa-pencil post-button edit\" aria-hidden=\"true\"></i>\n            <i class=\"fa fa-trash post-button delete\" aria-hidden=\"true\"></i>\n          </div>\n          <div >\n            ").concat(post.post_time, "\n          </div>\n          </div>\n          <hr/>\n          ");
      postsContainer.appendChild(postElement); //delete button event

      postElement.querySelector('.post-button.delete').addEventListener('click', function (e) {
        var element = e.target.parentElement.parentElement.parentElement;
        var post_id = parseInt(element.getAttribute('id'));
        var postArray = JSON.parse(localStorage.getItem('post'));
        postArray.splice(post_id, 1);
        localStorage.setItem('post', JSON.stringify(postArray));
        element.remove();
      });
      postElement.querySelector('.post-button.edit').addEventListener('click', function (e) {
        var element = e.target.parentElement.parentElement.parentElement;
        var post_id = parseInt(element.getAttribute('id'));
        var postArray = JSON.parse(localStorage.getItem('post'));
        var titleInput = editForm.querySelector('#edit-title');
        var bodyInput = editForm.querySelector('#edit-body');
        var editSubmit = editForm.querySelector('#edit-blog-form');
        edit_close_btn.addEventListener('click', function (e) {
          titleInput.value = "";
          bodyInput.value = "";
        ...
        editSubmit.addEventListener('submit', function (e) {
          e.preventDefault();
...
//# sourceMappingURL=/blog-app.e31bb0bc.js.map